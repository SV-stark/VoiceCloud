package com.audiobook.vc.core.data.store
...
public object StoreModule {
  ...
  @SingleIn(AppScope::class)
  @OledThemeStore
  private fun oledTheme(factory: VoiceDataStoreFactory): DataStore<Boolean> {
    return factory.boolean("oledTheme", defaultValue = false)
  }
